...
The birthweight dataset has **4342** observations and **20** variables.
These variables are: **babysex, bhead, blength, bwt, delwt, fincome,
...
From the RMSE plot above, **Model 3**, having the lowest RMSE, appears
...
The weather dataset has **365** observations and **6** variables. These
variables are: **date, id, name, prcp, tmax, tmin**.
...
<img src="p8105_hw6_jys2136_files/figure-gfm/coeff_det-1.png" width="90%" />
...
<img src="p8105_hw6_jys2136_files/figure-gfm/log_beta-1.png" width="90%" />

The 95% CI of R squared is: (0.8936684 , 0.927106).

The 95% CI of log(beta0\*beta1) is: (1.9649487 , 2.0588875).

From the distributions of the estimated r^2 and log(beta0\*beta1) values
